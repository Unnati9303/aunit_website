...
const Home1 = ({ mode }) => {
  ...
  useEffect(() => {
    ...
    let position = 0;
    const speed = 1.8; // 🔥 change speed here
        ...
        <div id="root text-neutral-900 bg-white dark:text-white dark:bg-neutral-900">
          ...
          >
            <div className="absolute inset-0 z-0">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#FF6B00]/5 via-transparent to-[#C0C0C0]/5"></div>
            </div>
...
"
                  ...
                  <NavLink
                    to="/contact"
                    className="px-8 py-4                   bg-gradient-to-br from-[#E2E8F0] via-[#CBD5E1] to-[#94A3B8]
...
<h2 className="text-3xl md:text-4xl font-bold mb-4">
  <span className="
    ...
    animate-pulse
    drop-shadow-[0_0_14px_rgba(255,107,0,0.6)]
  ...
  <span className="
    text-[#FF6B00]
    animate-pulse
    drop-shadow-[0_0_24px_rgba(255,107,0,0.9)]
    motion-safe:animate-[float_3s_ease-in-out_infinite]
  ">
    Services
  </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div
                  className="service-card text-neutral-900  dark:text-white
...
hover:shadow-lg 
                 ...
                 dark:bg-neutral-900 rounded-lg p-6 transition-all duration-300 hover:transform hover:-translate-y-2 group"
                >
                  ...
                  <Link
                    to="/testiminols#client-ecommerce"
...
hover:shadow-lg 
 dark:bg-neutral-900 rounded-lg p-6 transition-all duration-300 hover:transform hover:-translate-y-2 group"
                >
                  ...
                  <Link
                    to="/testiminols#client-mobile-app"
                    className="text-[#FF6B00] inline-flex items-center group-hover:text-white transition-colors duration-300"
                  >
                    Learn More
                    <svg
                ...
                <div
                  className="service-card text-neutral-900  dark:text-white                   bg-gradient-to-br from-[#E2E8F0] via-[#CBD5E1] to-[#94A3B8]
  border border-[#CBD5E1]
hover:shadow-lg 
  dark:bg-neutral-900 rounded-lg p-6 transition-all duration-300 hover:transform hover:-translate-y-2 group"
                >
...
hover:shadow-lg 
  dark:bg-neutral-900 rounded-lg p-6 transition-all duration-300 hover:transform hover:-translate-y-2 group"
                >
                  ...
                  <Link
                    to="/testiminols#our-work-with-clients"
                    className="text-[#FF6B00] inline-flex items-center group-hover:text-white transition-colors duration-300"
                  >
                    Learn More
                    <svg
...
hover:shadow-lg 
  dark:bg-neutral-900 rounded-lg p-6 transition-all duration-300 hover:transform hover:-translate-y-2 group"
              ...
              <div className="mt-16 text-center">
                <a
                  href="/contact"
                  className="inline-block px-8 py-4 text-white text-[17px]  bg-[#FF6B00] dark:text-White-800 font-semibold  rounded-md hover:bg-[#FF8A3D] transition-colors duration-300 animate__animated animate__fadeIn"
                >
                          ...
                          >
                            {[...images, ...images].map((image, idx) => (
                              <img
                                ...
                                src={image}
                                alt={`tech-${idx}`}
                                className="h-10 sm:h-12 md:h-14 lg:h-16 w-auto object-contain pointer-events-none"
                              />
                            ))}
                          </div>
                        </div>
